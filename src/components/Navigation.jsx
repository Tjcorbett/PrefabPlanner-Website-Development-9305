...
const { FiHome, FiEdit3, FiImage, FiInfo, FiPhone, FiTool, FiSettings, FiTruck } = FiIcons
...
const Navigation = () => {
  ...
  return (
    <motion.nav
      className="fixed top-20 left-0 right-0 z-40 bg-gray-900/90 backdrop-blur-sm border-b border-gray-700"
